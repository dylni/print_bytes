...
pub use print_bytes2::eprint_lossy;
pub use print_bytes2::eprintln_lossy;
pub use print_bytes2::print_lossy;
pub use print_bytes2::println_lossy;
pub use print_bytes2::write_lossy;
...
pub use print_bytes2::WriteLossy;
